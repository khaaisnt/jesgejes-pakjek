...
const DeleteCustomer = (myprops: props) => {
     ...
     const [show, setShow] = useState<boolean>(false)
        ...
        const handleSubmit = async (e: FormEvent) => {
          ...
          try {
            ...
            const response: any = await axiosInstance.delete(`/customer/${myprops.item.id}`, {
            ...
            if (!response.data.success) {
              toast(response.data.message, {
                type: "warning",
                containerId: `DeleteCustomer-${myprops.item.id}`,
              })
            }
  ...
  return (
    <div>
         <ToastContainer containerId={`DeleteCustomer-${myprops.item.id}`} />
         <button 
          type="button" 
        ...
        <Modal isShow={show}>
          <div className="w-full p-3">
            <h1 className="font-semibold text-lg text-black">Hapus Customer</h1>
