...
const DeleteSeat = ({ kursiId }: props) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const response: any = await axiosInstance.delete(`/train/wagon/seat/${kursiId}`, {
  ...
  return (
    <div>
      ...
      <button
        type="button"
        className="px-1 py-1 bg-red-600 hover:bg-red-500 duration-200 text-white rounded-full"
        onClick={openModal}
      >
        <svg
      ...
      <Modal isShow={show}>
        <div className="w-full p-3">
          <h1 className="font-semibold text-lg text-black">Hapus Kursi</h1>
