...
import { ScheduleTypes, User } from '../types'
     ...
     const [show, setShow] = useState<boolean>(false)
        ...
        const handleSubmit = async (e: FormEvent) => {
          ...
          try {
            ...
            const response: any = await axiosInstance.delete(`/schedule/${myprops.item.id}`, {
    ...
    <div>
        ...
        <Modal isShow={show}>
          <div className="w-full p-3">
            <h1 className="font-semibold text-lg text-black">Hapus Schedule</h1>
